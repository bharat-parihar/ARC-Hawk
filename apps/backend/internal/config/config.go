...
// ClassificationConfig contains weights for classification aggregation
// NOTE: Backend does NOT classify - these weights are only for legacy compatibility
// Scanner SDK is the sole classification authority
