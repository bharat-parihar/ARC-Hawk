...
if __name__ == "__main__":
    ...
    # Valid Aadhaar with correct checksum (check digits generated by Verhoeff algorithm)
    test_cases = [
        ("234567890124", True, "Valid Aadhaar"),  # Corrected: check digit is 4, not 6
        ("999911112222", False, "Invalid checksum"),
        ("111111111111", False, "Repeating sequence"),
        ("123456789012", False, "Linear sequence"),
        ("9999 1111 2221", True, "Valid with spaces"),  # Corrected: check digit is 1
    ]
    
    for number, expected, description in test_cases:
        # Clean spaces/hyphens from test input (just like validate_aadhaar does)
        clean = ''.join(c for c in number if c.isdigit())
        # Test with validate_aadhaar for comprehensive validation
        result = validate_aadhaar(number)
